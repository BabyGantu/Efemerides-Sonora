...
import 'package:tutorial1/datos/efemerides_muer.dart';
import 'package:tutorial1/modelo/efemerides_fun.dart';
import 'package:tutorial1/ventanacompartir.dart';

class PagDefunciones extends StatefulWidget {
  final DateTime? fechaElegida;
  final double fontSize;

  const PagDefunciones({Key? key, this.fechaElegida, required this.fontSize})
      : super(key: key);

  @override
  _PagDefuncionesState createState() => _PagDefuncionesState();
}

class _PagDefuncionesState extends State<PagDefunciones> {
  ...
  Widget build(BuildContext context) {
    ...
    return listViewItems.isEmpty
        ? Center(
      child: Text('No se encontraron defunciones con esta fecha'),
    )
        : ListView.builder(
